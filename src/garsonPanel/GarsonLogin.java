...
public class GarsonLogin extends javax.swing.JFrame {

    Garson as = new Garson();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Garson Giriş Paneli");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GarsonLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GarsonLogin().setVisible(true);
            }
        });
    }
